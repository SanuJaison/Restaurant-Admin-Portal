    ...
    filteredFoods.forEach((food) => {
        ...
        <div class="flex flex-col p-3 gap-3">
          ...
          <div class="text-center text-[#4b5563] text-sm space-x-2">
            ...
            <button
              onclick="editFood(${originalIndex})"
              class="bg-slate-200 px-6 py-1 rounded-2xl">
            ...
            <button
              onclick="deleteFood(${originalIndex})"
              class="bg-slate-200 px-6 py-1 rounded-2xl">
...
function editFood(index) {
    ...
    document.getElementById("tick").checked =
